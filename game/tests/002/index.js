...
var ASM_CONSTS = {
  89326: () => { if (document.fullscreenElement) return 1; },  
 89372: () => { return Module.canvas.width; },  
 89404: () => { return parseInt(Module.canvas.style.width); },  
 89452: () => { document.exitFullscreen(); },  
 89479: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89551: () => { if (document.fullscreenElement) return 1; },  
 89597: () => { return Module.canvas.width; },  
 89629: () => { return screen.width; },  
 89654: () => { document.exitFullscreen(); },  
 89681: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89875: () => { return window.innerWidth; },  
 89901: () => { return window.innerHeight; },  
 89928: () => { if (document.fullscreenElement) return 1; },  
 89974: () => { return Module.canvas.width; },  
 90006: () => { return parseInt(Module.canvas.style.width); },  
 90054: () => { if (document.fullscreenElement) return 1; },  
 90100: () => { return Module.canvas.width; },  
 90132: () => { return screen.width; },  
 90157: () => { return window.innerWidth; },  
 90183: () => { return window.innerHeight; },  
 90210: () => { if (document.fullscreenElement) return 1; },  
 90256: () => { return Module.canvas.width; },  
 90288: () => { return screen.width; },  
 90313: () => { document.exitFullscreen(); },  
 90340: () => { if (document.fullscreenElement) return 1; },  
 90386: () => { return Module.canvas.width; },  
 90418: () => { return parseInt(Module.canvas.style.width); },  
 90466: () => { document.exitFullscreen(); },  
 90493: ($0) => { Module.canvas.style.opacity = $0; },  
 90531: () => { return screen.width; },  
 90556: () => { return screen.height; },  
 90582: () => { return window.screenX; },  
 90609: () => { return window.screenY; },  
 90636: () => { return window.devicePixelRatio; },  
 90672: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90725: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90776: () => { Module.canvas.style.cursor = 'none'; },  
 90813: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91069: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91120: () => { if (document.pointerLockElement) return 1; },  
 91167: () => { if (document.fullscreenElement) return 1; },  
 91213: () => { return window.innerWidth; },  
 91239: () => { return window.innerHeight; }
};
