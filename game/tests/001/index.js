...
var ASM_CONSTS = {
  89310: () => { if (document.fullscreenElement) return 1; },  
 89356: () => { return Module.canvas.width; },  
 89388: () => { return parseInt(Module.canvas.style.width); },  
 89436: () => { document.exitFullscreen(); },  
 89463: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89535: () => { if (document.fullscreenElement) return 1; },  
 89581: () => { return Module.canvas.width; },  
 89613: () => { return screen.width; },  
 89638: () => { document.exitFullscreen(); },  
 89665: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89859: () => { return window.innerWidth; },  
 89885: () => { return window.innerHeight; },  
 89912: () => { if (document.fullscreenElement) return 1; },  
 89958: () => { return Module.canvas.width; },  
 89990: () => { return parseInt(Module.canvas.style.width); },  
 90038: () => { if (document.fullscreenElement) return 1; },  
 90084: () => { return Module.canvas.width; },  
 90116: () => { return screen.width; },  
 90141: () => { return window.innerWidth; },  
 90167: () => { return window.innerHeight; },  
 90194: () => { if (document.fullscreenElement) return 1; },  
 90240: () => { return Module.canvas.width; },  
 90272: () => { return screen.width; },  
 90297: () => { document.exitFullscreen(); },  
 90324: () => { if (document.fullscreenElement) return 1; },  
 90370: () => { return Module.canvas.width; },  
 90402: () => { return parseInt(Module.canvas.style.width); },  
 90450: () => { document.exitFullscreen(); },  
 90477: ($0) => { Module.canvas.style.opacity = $0; },  
 90515: () => { return screen.width; },  
 90540: () => { return screen.height; },  
 90566: () => { return window.screenX; },  
 90593: () => { return window.screenY; },  
 90620: () => { return window.devicePixelRatio; },  
 90656: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90709: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90760: () => { Module.canvas.style.cursor = 'none'; },  
 90797: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91053: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91104: () => { if (document.pointerLockElement) return 1; },  
 91151: () => { if (document.fullscreenElement) return 1; },  
 91197: () => { return window.innerWidth; },  
 91223: () => { return window.innerHeight; }
};
