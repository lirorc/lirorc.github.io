...
var ASM_CONSTS = {
  86462: () => { if (document.fullscreenElement) return 1; },  
 86508: () => { return Module.canvas.width; },  
 86540: () => { return parseInt(Module.canvas.style.width); },  
 86588: () => { document.exitFullscreen(); },  
 86615: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 86687: () => { if (document.fullscreenElement) return 1; },  
 86733: () => { return Module.canvas.width; },  
 86765: () => { return screen.width; },  
 86790: () => { document.exitFullscreen(); },  
 86817: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 87011: () => { return window.innerWidth; },  
 87037: () => { return window.innerHeight; },  
 87064: () => { if (document.fullscreenElement) return 1; },  
 87110: () => { return Module.canvas.width; },  
 87142: () => { return parseInt(Module.canvas.style.width); },  
 87190: () => { if (document.fullscreenElement) return 1; },  
 87236: () => { return Module.canvas.width; },  
 87268: () => { return screen.width; },  
 87293: () => { return window.innerWidth; },  
 87319: () => { return window.innerHeight; },  
 87346: () => { if (document.fullscreenElement) return 1; },  
 87392: () => { return Module.canvas.width; },  
 87424: () => { return screen.width; },  
 87449: () => { document.exitFullscreen(); },  
 87476: () => { if (document.fullscreenElement) return 1; },  
 87522: () => { return Module.canvas.width; },  
 87554: () => { return parseInt(Module.canvas.style.width); },  
 87602: () => { document.exitFullscreen(); },  
 87629: ($0) => { Module.canvas.style.opacity = $0; },  
 87667: () => { return screen.width; },  
 87692: () => { return screen.height; },  
 87718: () => { return window.screenX; },  
 87745: () => { return window.screenY; },  
 87772: () => { return window.devicePixelRatio; },  
 87808: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 87861: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 87912: () => { Module.canvas.style.cursor = 'none'; },  
 87949: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 88205: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 88256: () => { if (document.pointerLockElement) return 1; },  
 88303: () => { if (document.fullscreenElement) return 1; },  
 88349: () => { return window.innerWidth; },  
 88375: () => { return window.innerHeight; }
};
