...
var ASM_CONSTS = {
  349710: () => { if (document.fullscreenElement) return 1; },  
 349756: () => { return Module.canvas.width; },  
 349788: () => { return parseInt(Module.canvas.style.width); },  
 349836: () => { document.exitFullscreen(); },  
 349863: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 349935: () => { if (document.fullscreenElement) return 1; },  
 349981: () => { return Module.canvas.width; },  
 350013: () => { return screen.width; },  
 350038: () => { document.exitFullscreen(); },  
 350065: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 350259: () => { return window.innerWidth; },  
 350285: () => { return window.innerHeight; },  
 350312: () => { if (document.fullscreenElement) return 1; },  
 350358: () => { return Module.canvas.width; },  
 350390: () => { return parseInt(Module.canvas.style.width); },  
 350438: () => { if (document.fullscreenElement) return 1; },  
 350484: () => { return Module.canvas.width; },  
 350516: () => { return screen.width; },  
 350541: () => { return window.innerWidth; },  
 350567: () => { return window.innerHeight; },  
 350594: () => { if (document.fullscreenElement) return 1; },  
 350640: () => { return Module.canvas.width; },  
 350672: () => { return screen.width; },  
 350697: () => { document.exitFullscreen(); },  
 350724: () => { if (document.fullscreenElement) return 1; },  
 350770: () => { return Module.canvas.width; },  
 350802: () => { return parseInt(Module.canvas.style.width); },  
 350850: () => { document.exitFullscreen(); },  
 350877: ($0) => { Module.canvas.style.opacity = $0; },  
 350915: () => { return screen.width; },  
 350940: () => { return screen.height; },  
 350966: () => { return window.screenX; },  
 350993: () => { return window.screenY; },  
 351020: () => { return window.devicePixelRatio; },  
 351056: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 351109: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 351160: () => { Module.canvas.style.cursor = 'none'; },  
 351197: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 351453: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 351504: () => { if (document.pointerLockElement) return 1; },  
 351551: () => { if (document.fullscreenElement) return 1; },  
 351597: () => { return window.innerWidth; },  
 351623: () => { return window.innerHeight; }
};
