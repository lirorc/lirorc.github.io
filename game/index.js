...
var ASM_CONSTS = {
  315566: () => { if (document.fullscreenElement) return 1; },  
 315612: () => { return Module.canvas.width; },  
 315644: () => { return parseInt(Module.canvas.style.width); },  
 315692: () => { document.exitFullscreen(); },  
 315719: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 315791: () => { if (document.fullscreenElement) return 1; },  
 315837: () => { return Module.canvas.width; },  
 315869: () => { return screen.width; },  
 315894: () => { document.exitFullscreen(); },  
 315921: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 316115: () => { return window.innerWidth; },  
 316141: () => { return window.innerHeight; },  
 316168: () => { if (document.fullscreenElement) return 1; },  
 316214: () => { return Module.canvas.width; },  
 316246: () => { return parseInt(Module.canvas.style.width); },  
 316294: () => { if (document.fullscreenElement) return 1; },  
 316340: () => { return Module.canvas.width; },  
 316372: () => { return screen.width; },  
 316397: () => { return window.innerWidth; },  
 316423: () => { return window.innerHeight; },  
 316450: () => { if (document.fullscreenElement) return 1; },  
 316496: () => { return Module.canvas.width; },  
 316528: () => { return screen.width; },  
 316553: () => { document.exitFullscreen(); },  
 316580: () => { if (document.fullscreenElement) return 1; },  
 316626: () => { return Module.canvas.width; },  
 316658: () => { return parseInt(Module.canvas.style.width); },  
 316706: () => { document.exitFullscreen(); },  
 316733: ($0) => { Module.canvas.style.opacity = $0; },  
 316771: () => { return screen.width; },  
 316796: () => { return screen.height; },  
 316822: () => { return window.screenX; },  
 316849: () => { return window.screenY; },  
 316876: () => { return window.devicePixelRatio; },  
 316912: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 316965: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 317016: () => { Module.canvas.style.cursor = 'none'; },  
 317053: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 317309: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 317360: () => { if (document.pointerLockElement) return 1; },  
 317407: () => { if (document.fullscreenElement) return 1; },  
 317453: () => { return window.innerWidth; },  
 317479: () => { return window.innerHeight; }
};
