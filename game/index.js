...
var ASM_CONSTS = {
  127662: () => { if (document.fullscreenElement) return 1; },  
 127708: () => { return Module.canvas.width; },  
 127740: () => { return parseInt(Module.canvas.style.width); },  
 127788: () => { document.exitFullscreen(); },  
 127815: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 127887: () => { if (document.fullscreenElement) return 1; },  
 127933: () => { return Module.canvas.width; },  
 127965: () => { return screen.width; },  
 127990: () => { document.exitFullscreen(); },  
 128017: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 128211: () => { return window.innerWidth; },  
 128237: () => { return window.innerHeight; },  
 128264: () => { if (document.fullscreenElement) return 1; },  
 128310: () => { return Module.canvas.width; },  
 128342: () => { return parseInt(Module.canvas.style.width); },  
 128390: () => { if (document.fullscreenElement) return 1; },  
 128436: () => { return Module.canvas.width; },  
 128468: () => { return screen.width; },  
 128493: () => { return window.innerWidth; },  
 128519: () => { return window.innerHeight; },  
 128546: () => { if (document.fullscreenElement) return 1; },  
 128592: () => { return Module.canvas.width; },  
 128624: () => { return screen.width; },  
 128649: () => { document.exitFullscreen(); },  
 128676: () => { if (document.fullscreenElement) return 1; },  
 128722: () => { return Module.canvas.width; },  
 128754: () => { return parseInt(Module.canvas.style.width); },  
 128802: () => { document.exitFullscreen(); },  
 128829: ($0) => { Module.canvas.style.opacity = $0; },  
 128867: () => { return screen.width; },  
 128892: () => { return screen.height; },  
 128918: () => { return window.screenX; },  
 128945: () => { return window.screenY; },  
 128972: () => { return window.devicePixelRatio; },  
 129008: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129061: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129112: () => { Module.canvas.style.cursor = 'none'; },  
 129149: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 129405: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129456: () => { if (document.pointerLockElement) return 1; },  
 129503: () => { if (document.fullscreenElement) return 1; },  
 129549: () => { return window.innerWidth; },  
 129575: () => { return window.innerHeight; }
};
