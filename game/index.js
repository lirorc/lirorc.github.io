...
var ASM_CONSTS = {
  215086: () => { if (document.fullscreenElement) return 1; },  
 215132: () => { return Module.canvas.width; },  
 215164: () => { return parseInt(Module.canvas.style.width); },  
 215212: () => { document.exitFullscreen(); },  
 215239: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 215311: () => { if (document.fullscreenElement) return 1; },  
 215357: () => { return Module.canvas.width; },  
 215389: () => { return screen.width; },  
 215414: () => { document.exitFullscreen(); },  
 215441: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 215635: () => { return window.innerWidth; },  
 215661: () => { return window.innerHeight; },  
 215688: () => { if (document.fullscreenElement) return 1; },  
 215734: () => { return Module.canvas.width; },  
 215766: () => { return parseInt(Module.canvas.style.width); },  
 215814: () => { if (document.fullscreenElement) return 1; },  
 215860: () => { return Module.canvas.width; },  
 215892: () => { return screen.width; },  
 215917: () => { return window.innerWidth; },  
 215943: () => { return window.innerHeight; },  
 215970: () => { if (document.fullscreenElement) return 1; },  
 216016: () => { return Module.canvas.width; },  
 216048: () => { return screen.width; },  
 216073: () => { document.exitFullscreen(); },  
 216100: () => { if (document.fullscreenElement) return 1; },  
 216146: () => { return Module.canvas.width; },  
 216178: () => { return parseInt(Module.canvas.style.width); },  
 216226: () => { document.exitFullscreen(); },  
 216253: ($0) => { Module.canvas.style.opacity = $0; },  
 216291: () => { return screen.width; },  
 216316: () => { return screen.height; },  
 216342: () => { return window.screenX; },  
 216369: () => { return window.screenY; },  
 216396: () => { return window.devicePixelRatio; },  
 216432: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 216485: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 216536: () => { Module.canvas.style.cursor = 'none'; },  
 216573: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 216829: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 216880: () => { if (document.pointerLockElement) return 1; },  
 216927: () => { if (document.fullscreenElement) return 1; },  
 216973: () => { return window.innerWidth; },  
 216999: () => { return window.innerHeight; }
};
