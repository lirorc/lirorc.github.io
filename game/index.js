...
var ASM_CONSTS = {
  127150: () => { if (document.fullscreenElement) return 1; },  
 127196: () => { return Module.canvas.width; },  
 127228: () => { return parseInt(Module.canvas.style.width); },  
 127276: () => { document.exitFullscreen(); },  
 127303: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 127375: () => { if (document.fullscreenElement) return 1; },  
 127421: () => { return Module.canvas.width; },  
 127453: () => { return screen.width; },  
 127478: () => { document.exitFullscreen(); },  
 127505: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 127699: () => { return window.innerWidth; },  
 127725: () => { return window.innerHeight; },  
 127752: () => { if (document.fullscreenElement) return 1; },  
 127798: () => { return Module.canvas.width; },  
 127830: () => { return parseInt(Module.canvas.style.width); },  
 127878: () => { if (document.fullscreenElement) return 1; },  
 127924: () => { return Module.canvas.width; },  
 127956: () => { return screen.width; },  
 127981: () => { return window.innerWidth; },  
 128007: () => { return window.innerHeight; },  
 128034: () => { if (document.fullscreenElement) return 1; },  
 128080: () => { return Module.canvas.width; },  
 128112: () => { return screen.width; },  
 128137: () => { document.exitFullscreen(); },  
 128164: () => { if (document.fullscreenElement) return 1; },  
 128210: () => { return Module.canvas.width; },  
 128242: () => { return parseInt(Module.canvas.style.width); },  
 128290: () => { document.exitFullscreen(); },  
 128317: ($0) => { Module.canvas.style.opacity = $0; },  
 128355: () => { return screen.width; },  
 128380: () => { return screen.height; },  
 128406: () => { return window.screenX; },  
 128433: () => { return window.screenY; },  
 128460: () => { return window.devicePixelRatio; },  
 128496: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 128549: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128600: () => { Module.canvas.style.cursor = 'none'; },  
 128637: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 128893: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128944: () => { if (document.pointerLockElement) return 1; },  
 128991: () => { if (document.fullscreenElement) return 1; },  
 129037: () => { return window.innerWidth; },  
 129063: () => { return window.innerHeight; }
};
