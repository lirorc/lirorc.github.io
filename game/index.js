...
var ASM_CONSTS = {
  175790: () => { if (document.fullscreenElement) return 1; },  
 175836: () => { return Module.canvas.width; },  
 175868: () => { return parseInt(Module.canvas.style.width); },  
 175916: () => { document.exitFullscreen(); },  
 175943: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 176015: () => { if (document.fullscreenElement) return 1; },  
 176061: () => { return Module.canvas.width; },  
 176093: () => { return screen.width; },  
 176118: () => { document.exitFullscreen(); },  
 176145: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 176339: () => { return window.innerWidth; },  
 176365: () => { return window.innerHeight; },  
 176392: () => { if (document.fullscreenElement) return 1; },  
 176438: () => { return Module.canvas.width; },  
 176470: () => { return parseInt(Module.canvas.style.width); },  
 176518: () => { if (document.fullscreenElement) return 1; },  
 176564: () => { return Module.canvas.width; },  
 176596: () => { return screen.width; },  
 176621: () => { return window.innerWidth; },  
 176647: () => { return window.innerHeight; },  
 176674: () => { if (document.fullscreenElement) return 1; },  
 176720: () => { return Module.canvas.width; },  
 176752: () => { return screen.width; },  
 176777: () => { document.exitFullscreen(); },  
 176804: () => { if (document.fullscreenElement) return 1; },  
 176850: () => { return Module.canvas.width; },  
 176882: () => { return parseInt(Module.canvas.style.width); },  
 176930: () => { document.exitFullscreen(); },  
 176957: ($0) => { Module.canvas.style.opacity = $0; },  
 176995: () => { return screen.width; },  
 177020: () => { return screen.height; },  
 177046: () => { return window.screenX; },  
 177073: () => { return window.screenY; },  
 177100: () => { return window.devicePixelRatio; },  
 177136: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 177189: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 177240: () => { Module.canvas.style.cursor = 'none'; },  
 177277: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 177533: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 177584: () => { if (document.pointerLockElement) return 1; },  
 177631: () => { if (document.fullscreenElement) return 1; },  
 177677: () => { return window.innerWidth; },  
 177703: () => { return window.innerHeight; }
};
