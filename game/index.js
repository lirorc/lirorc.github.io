...
var ASM_CONSTS = {
  127694: () => { if (document.fullscreenElement) return 1; },  
 127740: () => { return Module.canvas.width; },  
 127772: () => { return parseInt(Module.canvas.style.width); },  
 127820: () => { document.exitFullscreen(); },  
 127847: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 127919: () => { if (document.fullscreenElement) return 1; },  
 127965: () => { return Module.canvas.width; },  
 127997: () => { return screen.width; },  
 128022: () => { document.exitFullscreen(); },  
 128049: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 128243: () => { return window.innerWidth; },  
 128269: () => { return window.innerHeight; },  
 128296: () => { if (document.fullscreenElement) return 1; },  
 128342: () => { return Module.canvas.width; },  
 128374: () => { return parseInt(Module.canvas.style.width); },  
 128422: () => { if (document.fullscreenElement) return 1; },  
 128468: () => { return Module.canvas.width; },  
 128500: () => { return screen.width; },  
 128525: () => { return window.innerWidth; },  
 128551: () => { return window.innerHeight; },  
 128578: () => { if (document.fullscreenElement) return 1; },  
 128624: () => { return Module.canvas.width; },  
 128656: () => { return screen.width; },  
 128681: () => { document.exitFullscreen(); },  
 128708: () => { if (document.fullscreenElement) return 1; },  
 128754: () => { return Module.canvas.width; },  
 128786: () => { return parseInt(Module.canvas.style.width); },  
 128834: () => { document.exitFullscreen(); },  
 128861: ($0) => { Module.canvas.style.opacity = $0; },  
 128899: () => { return screen.width; },  
 128924: () => { return screen.height; },  
 128950: () => { return window.screenX; },  
 128977: () => { return window.screenY; },  
 129004: () => { return window.devicePixelRatio; },  
 129040: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129093: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129144: () => { Module.canvas.style.cursor = 'none'; },  
 129181: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 129437: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129488: () => { if (document.pointerLockElement) return 1; },  
 129535: () => { if (document.fullscreenElement) return 1; },  
 129581: () => { return window.innerWidth; },  
 129607: () => { return window.innerHeight; }
};
