...
var ASM_CONSTS = {
 ...
 127916: () => { return Module.canvas.width; },  
 127948: () => { return parseInt(Module.canvas.style.width); },  
 127996: () => { document.exitFullscreen(); },  
 128023: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 128095: () => { if (document.fullscreenElement) return 1; },  
 128141: () => { return Module.canvas.width; },  
 128173: () => { return screen.width; },  
 128198: () => { document.exitFullscreen(); },  
 128225: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 128419: () => { return window.innerWidth; },  
 128445: () => { return window.innerHeight; },  
 128472: () => { if (document.fullscreenElement) return 1; },  
 128518: () => { return Module.canvas.width; },  
 128550: () => { return parseInt(Module.canvas.style.width); },  
 128598: () => { if (document.fullscreenElement) return 1; },  
 128644: () => { return Module.canvas.width; },  
 128676: () => { return screen.width; },  
 128701: () => { return window.innerWidth; },  
 128727: () => { return window.innerHeight; },  
 128754: () => { if (document.fullscreenElement) return 1; },  
 128800: () => { return Module.canvas.width; },  
 128832: () => { return screen.width; },  
 128857: () => { document.exitFullscreen(); },  
 128884: () => { if (document.fullscreenElement) return 1; },  
 128930: () => { return Module.canvas.width; },  
 128962: () => { return parseInt(Module.canvas.style.width); },  
 129010: () => { document.exitFullscreen(); },  
 129037: ($0) => { Module.canvas.style.opacity = $0; },  
 129075: () => { return screen.width; },  
 129100: () => { return screen.height; },  
 129126: () => { return window.screenX; },  
 129153: () => { return window.screenY; },  
 129180: () => { return window.devicePixelRatio; },  
 129216: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129269: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129320: () => { Module.canvas.style.cursor = 'none'; },  
 129357: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 129613: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129664: () => { if (document.pointerLockElement) return 1; },  
 129711: () => { if (document.fullscreenElement) return 1; },  
 129757: () => { return window.innerWidth; },  
 129783: () => { return window.innerHeight; }
};
