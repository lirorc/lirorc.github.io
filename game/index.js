...
var ASM_CONSTS = {
  127726: () => { if (document.fullscreenElement) return 1; },  
 127772: () => { return Module.canvas.width; },  
 127804: () => { return parseInt(Module.canvas.style.width); },  
 127852: () => { document.exitFullscreen(); },  
 127879: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 127951: () => { if (document.fullscreenElement) return 1; },  
 127997: () => { return Module.canvas.width; },  
 128029: () => { return screen.width; },  
 128054: () => { document.exitFullscreen(); },  
 128081: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 128275: () => { return window.innerWidth; },  
 128301: () => { return window.innerHeight; },  
 128328: () => { if (document.fullscreenElement) return 1; },  
 128374: () => { return Module.canvas.width; },  
 128406: () => { return parseInt(Module.canvas.style.width); },  
 128454: () => { if (document.fullscreenElement) return 1; },  
 128500: () => { return Module.canvas.width; },  
 128532: () => { return screen.width; },  
 128557: () => { return window.innerWidth; },  
 128583: () => { return window.innerHeight; },  
 128610: () => { if (document.fullscreenElement) return 1; },  
 128656: () => { return Module.canvas.width; },  
 128688: () => { return screen.width; },  
 128713: () => { document.exitFullscreen(); },  
 128740: () => { if (document.fullscreenElement) return 1; },  
 128786: () => { return Module.canvas.width; },  
 128818: () => { return parseInt(Module.canvas.style.width); },  
 128866: () => { document.exitFullscreen(); },  
 128893: ($0) => { Module.canvas.style.opacity = $0; },  
 128931: () => { return screen.width; },  
 128956: () => { return screen.height; },  
 128982: () => { return window.screenX; },  
 129009: () => { return window.screenY; },  
 129036: () => { return window.devicePixelRatio; },  
 129072: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129125: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129176: () => { Module.canvas.style.cursor = 'none'; },  
 129213: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 129469: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129520: () => { if (document.pointerLockElement) return 1; },  
 129567: () => { if (document.fullscreenElement) return 1; },  
 129613: () => { return window.innerWidth; },  
 129639: () => { return window.innerHeight; }
};
