...
var ASM_CONSTS = {
  90190: () => { if (document.fullscreenElement) return 1; },  
 90236: () => { return Module.canvas.width; },  
 90268: () => { return parseInt(Module.canvas.style.width); },  
 90316: () => { document.exitFullscreen(); },  
 90343: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90415: () => { if (document.fullscreenElement) return 1; },  
 90461: () => { return Module.canvas.width; },  
 90493: () => { return screen.width; },  
 90518: () => { document.exitFullscreen(); },  
 90545: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90739: () => { return window.innerWidth; },  
 90765: () => { return window.innerHeight; },  
 90792: () => { if (document.fullscreenElement) return 1; },  
 90838: () => { return Module.canvas.width; },  
 90870: () => { return parseInt(Module.canvas.style.width); },  
 90918: () => { if (document.fullscreenElement) return 1; },  
 90964: () => { return Module.canvas.width; },  
 90996: () => { return screen.width; },  
 91021: () => { return window.innerWidth; },  
 91047: () => { return window.innerHeight; },  
 91074: () => { if (document.fullscreenElement) return 1; },  
 91120: () => { return Module.canvas.width; },  
 91152: () => { return screen.width; },  
 91177: () => { document.exitFullscreen(); },  
 91204: () => { if (document.fullscreenElement) return 1; },  
 91250: () => { return Module.canvas.width; },  
 91282: () => { return parseInt(Module.canvas.style.width); },  
 91330: () => { document.exitFullscreen(); },  
 91357: ($0) => { Module.canvas.style.opacity = $0; },  
 91395: () => { return screen.width; },  
 91420: () => { return screen.height; },  
 91446: () => { return window.screenX; },  
 91473: () => { return window.screenY; },  
 91500: () => { return window.devicePixelRatio; },  
 91536: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91589: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91640: () => { Module.canvas.style.cursor = 'none'; },  
 91677: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91933: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91984: () => { if (document.pointerLockElement) return 1; },  
 92031: () => { if (document.fullscreenElement) return 1; },  
 92077: () => { return window.innerWidth; },  
 92103: () => { return window.innerHeight; }
};
