...
var ASM_CONSTS = {
  240206: () => { if (document.fullscreenElement) return 1; },  
 240252: () => { return Module.canvas.width; },  
 240284: () => { return parseInt(Module.canvas.style.width); },  
 240332: () => { document.exitFullscreen(); },  
 240359: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 240431: () => { if (document.fullscreenElement) return 1; },  
 240477: () => { return Module.canvas.width; },  
 240509: () => { return screen.width; },  
 240534: () => { document.exitFullscreen(); },  
 240561: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 240755: () => { return window.innerWidth; },  
 240781: () => { return window.innerHeight; },  
 240808: () => { if (document.fullscreenElement) return 1; },  
 240854: () => { return Module.canvas.width; },  
 240886: () => { return parseInt(Module.canvas.style.width); },  
 240934: () => { if (document.fullscreenElement) return 1; },  
 240980: () => { return Module.canvas.width; },  
 241012: () => { return screen.width; },  
 241037: () => { return window.innerWidth; },  
 241063: () => { return window.innerHeight; },  
 241090: () => { if (document.fullscreenElement) return 1; },  
 241136: () => { return Module.canvas.width; },  
 241168: () => { return screen.width; },  
 241193: () => { document.exitFullscreen(); },  
 241220: () => { if (document.fullscreenElement) return 1; },  
 241266: () => { return Module.canvas.width; },  
 241298: () => { return parseInt(Module.canvas.style.width); },  
 241346: () => { document.exitFullscreen(); },  
 241373: ($0) => { Module.canvas.style.opacity = $0; },  
 241411: () => { return screen.width; },  
 241436: () => { return screen.height; },  
 241462: () => { return window.screenX; },  
 241489: () => { return window.screenY; },  
 241516: () => { return window.devicePixelRatio; },  
 241552: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 241605: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 241656: () => { Module.canvas.style.cursor = 'none'; },  
 241693: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 241949: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 242000: () => { if (document.pointerLockElement) return 1; },  
 242047: () => { if (document.fullscreenElement) return 1; },  
 242093: () => { return window.innerWidth; },  
 242119: () => { return window.innerHeight; }
};
