...
var ASM_CONSTS = {
  500062: () => { if (document.fullscreenElement) return 1; },  
 500108: () => { return Module.canvas.width; },  
 500140: () => { return parseInt(Module.canvas.style.width); },  
 500188: () => { document.exitFullscreen(); },  
 500215: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 500287: () => { if (document.fullscreenElement) return 1; },  
 500333: () => { return Module.canvas.width; },  
 500365: () => { return screen.width; },  
 500390: () => { document.exitFullscreen(); },  
 500417: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 500611: () => { return window.innerWidth; },  
 500637: () => { return window.innerHeight; },  
 500664: () => { if (document.fullscreenElement) return 1; },  
 500710: () => { return Module.canvas.width; },  
 500742: () => { return parseInt(Module.canvas.style.width); },  
 500790: () => { if (document.fullscreenElement) return 1; },  
 500836: () => { return Module.canvas.width; },  
 500868: () => { return screen.width; },  
 500893: () => { return window.innerWidth; },  
 500919: () => { return window.innerHeight; },  
 500946: () => { if (document.fullscreenElement) return 1; },  
 500992: () => { return Module.canvas.width; },  
 501024: () => { return screen.width; },  
 501049: () => { document.exitFullscreen(); },  
 501076: () => { if (document.fullscreenElement) return 1; },  
 501122: () => { return Module.canvas.width; },  
 501154: () => { return parseInt(Module.canvas.style.width); },  
 501202: () => { document.exitFullscreen(); },  
 501229: ($0) => { Module.canvas.style.opacity = $0; },  
 501267: () => { return screen.width; },  
 501292: () => { return screen.height; },  
 501318: () => { return window.screenX; },  
 501345: () => { return window.screenY; },  
 501372: () => { return window.devicePixelRatio; },  
 501408: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 501461: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 501512: () => { Module.canvas.style.cursor = 'none'; },  
 501549: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 501805: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 501856: () => { if (document.pointerLockElement) return 1; },  
 501903: () => { if (document.fullscreenElement) return 1; },  
 501949: () => { return window.innerWidth; },  
 501975: () => { return window.innerHeight; }
};
