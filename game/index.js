...
var ASM_CONSTS = {
  290446: () => { if (document.fullscreenElement) return 1; },  
 290492: () => { return Module.canvas.width; },  
 290524: () => { return parseInt(Module.canvas.style.width); },  
 290572: () => { document.exitFullscreen(); },  
 290599: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 290671: () => { if (document.fullscreenElement) return 1; },  
 290717: () => { return Module.canvas.width; },  
 290749: () => { return screen.width; },  
 290774: () => { document.exitFullscreen(); },  
 290801: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 290995: () => { return window.innerWidth; },  
 291021: () => { return window.innerHeight; },  
 291048: () => { if (document.fullscreenElement) return 1; },  
 291094: () => { return Module.canvas.width; },  
 291126: () => { return parseInt(Module.canvas.style.width); },  
 291174: () => { if (document.fullscreenElement) return 1; },  
 291220: () => { return Module.canvas.width; },  
 291252: () => { return screen.width; },  
 291277: () => { return window.innerWidth; },  
 291303: () => { return window.innerHeight; },  
 291330: () => { if (document.fullscreenElement) return 1; },  
 291376: () => { return Module.canvas.width; },  
 291408: () => { return screen.width; },  
 291433: () => { document.exitFullscreen(); },  
 291460: () => { if (document.fullscreenElement) return 1; },  
 291506: () => { return Module.canvas.width; },  
 291538: () => { return parseInt(Module.canvas.style.width); },  
 291586: () => { document.exitFullscreen(); },  
 291613: ($0) => { Module.canvas.style.opacity = $0; },  
 291651: () => { return screen.width; },  
 291676: () => { return screen.height; },  
 291702: () => { return window.screenX; },  
 291729: () => { return window.screenY; },  
 291756: () => { return window.devicePixelRatio; },  
 291792: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 291845: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 291896: () => { Module.canvas.style.cursor = 'none'; },  
 291933: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 292189: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 292240: () => { if (document.pointerLockElement) return 1; },  
 292287: () => { if (document.fullscreenElement) return 1; },  
 292333: () => { return window.innerWidth; },  
 292359: () => { return window.innerHeight; }
};
