...
var ASM_CONSTS = {
  265326: () => { if (document.fullscreenElement) return 1; },  
 265372: () => { return Module.canvas.width; },  
 265404: () => { return parseInt(Module.canvas.style.width); },  
 265452: () => { document.exitFullscreen(); },  
 265479: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 265551: () => { if (document.fullscreenElement) return 1; },  
 265597: () => { return Module.canvas.width; },  
 265629: () => { return screen.width; },  
 265654: () => { document.exitFullscreen(); },  
 265681: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 265875: () => { return window.innerWidth; },  
 265901: () => { return window.innerHeight; },  
 265928: () => { if (document.fullscreenElement) return 1; },  
 265974: () => { return Module.canvas.width; },  
 266006: () => { return parseInt(Module.canvas.style.width); },  
 266054: () => { if (document.fullscreenElement) return 1; },  
 266100: () => { return Module.canvas.width; },  
 266132: () => { return screen.width; },  
 266157: () => { return window.innerWidth; },  
 266183: () => { return window.innerHeight; },  
 266210: () => { if (document.fullscreenElement) return 1; },  
 266256: () => { return Module.canvas.width; },  
 266288: () => { return screen.width; },  
 266313: () => { document.exitFullscreen(); },  
 266340: () => { if (document.fullscreenElement) return 1; },  
 266386: () => { return Module.canvas.width; },  
 266418: () => { return parseInt(Module.canvas.style.width); },  
 266466: () => { document.exitFullscreen(); },  
 266493: ($0) => { Module.canvas.style.opacity = $0; },  
 266531: () => { return screen.width; },  
 266556: () => { return screen.height; },  
 266582: () => { return window.screenX; },  
 266609: () => { return window.screenY; },  
 266636: () => { return window.devicePixelRatio; },  
 266672: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266725: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 266776: () => { Module.canvas.style.cursor = 'none'; },  
 266813: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267069: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 267120: () => { if (document.pointerLockElement) return 1; },  
 267167: () => { if (document.fullscreenElement) return 1; },  
 267213: () => { return window.innerWidth; },  
 267239: () => { return window.innerHeight; }
};
